...
<c:if test="${user.user_roleid == '2' && user.user_rolename != null  && username != null && username.trim().length() >0}">		
	...
	<div align="center">
		<h1>User Profile</h1>
		<form:form id="profileform"  method="post" modelAttribute="user">
	      ...
	      <span>${successMessage}</span>
	       <table width="80%" height="100%"> 
	        ...
	        <form:hidden path="user_rolename"/>
	        <tr>
			...
			<td width="60%"><form:input readonly="true" path="user_name"/>
			...
			<td width="60%"><input type="button" onclick="saveprofile();" value="Save"/></td>	
			</tr>			
			</table>
...
<div style="display: flex; justify-content: center; align-items: center;">
  <img src="images/cow.gif" alt="cow GIF" height="10%" width="10%">
</div>
